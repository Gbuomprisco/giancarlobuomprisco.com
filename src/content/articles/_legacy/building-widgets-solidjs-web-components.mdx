...
Being a JSX-based UI library, it's naturally very similar to _React_; nonetheless, it has some peculiar differences and, more importantly, exciting strengths over React.
...
The best part? No compromise on your DX (developer experience): Solid supports Typescript, _hooks_, Suspense-like features, SSR, SSG, and you can easily bundle it with modern tools (such as Rollup).
