---
date: '2019-06-27T00:00:00.322Z'
title: Abstracting State with Facades
series: 'State Management with NgRx'
coverImage: /assets/images/posts/state-management-with-ngrx.png
excerpt: Using Ngrx facades to connect your components with your state
...
<div [ngSwitch]="tile.assetId" fxLayout="column">
  ...
  <div class="tile-content" fxFlexAlign="center center">
    <cf-asset-pricer *ngSwitchDefault [asset]="tile.assetId"> </cf-asset-pricer>
  </div>
</div>
```
