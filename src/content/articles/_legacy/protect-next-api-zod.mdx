...
import CodeSandboxSnippet from '../../../components/mdx/CodeSandboxSnippet.astro';
...
reasonably well, such as _Joi_ and _class-validator_, which I have used
...
<CodeSandboxSnippet
  src={
    'https://codesandbox.io/embed/ts-zod-validation-czrej?fontsize=14&hidenavigation=1&theme=dark'
  }
/>
