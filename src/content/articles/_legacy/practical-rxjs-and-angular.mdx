---
date: '2019-04-26T00:00:00.322Z'
title: 'Practical RxJS and Angular'
coverImage: /assets/images/posts/practical-rx-and-angular.gif
excerpt: Practical scenarios with Angular and RxJS, going through useful patterns you may use and what to look out for
...
<div *ngIf="(searchResult$ | async) as searchResult">
  ...
  <ng-container [ngSwitch]="searchResult.items.length">
    <ng-container *ngSwitchCase="0"> No results found </ng-container>

    <ng-container *ngSwitchDefault>
      <div *ngFor="let result of searchResult.items">{{ result.name }}</div>
    </ng-container>
  </ng-container>
</div>
```
      ...
      <div class="d-flex justify-content-between row" *ngSwitchDefault>
        ...
        <div>
          ...
          <div *ngIf="(selectedRepository$ | async) as selectedRepository">
            ...
            <img
              [attr.src]="selectedRepository.owner.avatar_url"
              width="200"
              height="auto"
              alt="avatar"
            />
