---
date: '2019-05-02T00:00:00.322Z'
title: 'Introduction'
series: 'State Management with NgRx'
coverImage: /assets/images/posts/stae-managemen-with-ngrx.png
excerpt: An Introduction to the NGRX platform — Concepts, Best Practices, and Tips
...
export const selectAllWidgets = createSelector(selectDashboardState, selectAll);
```
...
export class WidgetsEffects {
  ...
  @Effect()
  createWidget$: Observable<AddWidgetAction> = this.actions$.pipe(
  ...
  exportWidgets$: Observable<void> = this.actions$.pipe(
