...
If you're like me and are primarily used to template-based frameworks (such as Vue or Angular), you may be used to directives or components that take care of the flow: conditions, for-loops, switch, etc.
