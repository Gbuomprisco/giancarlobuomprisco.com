...
Let's assume we have a component which accepts another one.
...
I am generally happy with the readability that this offers compared to ternaries, &&, or other weird ways that also make Typescript happy.
