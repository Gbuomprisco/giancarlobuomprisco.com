...
Web3 is a relatively new, revolutionary (maybe), and controversial (very) phenomenon, considered as the evolution of the Web as we know it today, and becoming harder and harder to ignore.
...
We are not here to discuss its qualities but to show how to start working with Web3 websites using the MetaMask wallet.

---

Recently, I started working on a task for requesting users to connect their wallets to retrieve their MetaMask addresse; I had the opportunity to get my hands dirty with a Web3 technologies for the first time.
