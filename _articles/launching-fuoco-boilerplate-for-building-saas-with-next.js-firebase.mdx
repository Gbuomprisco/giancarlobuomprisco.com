...
title: I'm launching Fuoco - A Boilerplate for building a SaaS with Next.js and Firebase
excerpt: Fuoco is a SaaS boilerplate for Next.js and Firebase. It comes with authentication,
  organizations, payments with Stripe, a blog and documentation generators, and much more.
...
**That's why I'm building Fuoco**. It's for you and me, indie-hackers and solopreneurs. It's for making quick, but also well. 
...
Fuoco will be a unified, SSR-rendered website. Marketing and App will use the same codebase, and the authentication will be persisted in all the pages. 

In 2022, this is what a modern website should look like.

Fuoco will provide, out-of-the-box, the following features:
...
Those are why I will release Fuoco as a private Github repository rather than a collection of libraries.
