...
date: '2020-08-01T00:00:00.322Z'
coverImage: /assets/images/posts/intersection-observer.webp
excerpt: This article shows how to build a directive with Angular that uses the Intersection Observer API to check when an element becomes visible on the page
