---
date: 2021-10-29T00:00:00.322Z
title: An Overview
coverImage: "/assets/images/posts/introduction-to-firebase-overview.webp"
excerpt: 'Firebase is Gooogle''s PaaS, geared towards mobile apps but perfect for
  any kind of application. This post is a brief introduction to Firebase: what it
  is, what you can use it for, and how to get started'
live: true
tags:
- firebase
collection: firebase
...
Whenever your function scales down to 0 instances (for example, during periods of inactivity), the _functions_ wake up from scratch; it's common and expected in the serverless world, with no definitive way to entirely remove these from the equation.
