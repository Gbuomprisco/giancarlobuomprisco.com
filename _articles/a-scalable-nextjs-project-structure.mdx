...
I applied most of these concepts to my product [Makerkit, a SaaS Starter for Next.js and Firebase]
(https://makerkit.dev). I write plenty of content over there too, check it out!
